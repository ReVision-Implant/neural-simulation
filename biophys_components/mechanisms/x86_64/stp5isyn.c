...
#define nrn_init _nrn_init__stp5isyn
#define _nrn_initial _nrn_initial__stp5isyn
#define nrn_cur _nrn_cur__stp5isyn
#define _nrn_current _nrn_current__stp5isyn
#define nrn_jacob _nrn_jacob__stp5isyn
#define nrn_state _nrn_state__stp5isyn
#define _net_receive _net_receive__stp5isyn 
#define state state__stp5isyn 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 stp5isyn /users/mns/lapolina/Desktop/bmtk-release-v1.0.0/docs/examples/biophys_components/mechanisms/modfiles/stp5isyn.mod\n");
...
static void _initlists(){
 ...
 _slist1[3] = &(tau_r) - _p;  _dlist1[3] = &(Dtau_r) - _p;
 _slist1[4] = &(D) - _p;  _dlist1[4] = &(DD) - _p;
 _slist1[5] = &(pb) - _p;  _dlist1[5] = &(Dpb) - _p;
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/users/mns/lapolina/Desktop/bmtk-release-v1.0.0/docs/examples/biophys_components/mechanisms/modfiles/stp5isyn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
