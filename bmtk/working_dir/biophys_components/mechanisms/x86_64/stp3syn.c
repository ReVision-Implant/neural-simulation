...
#define nrn_init _nrn_init__stp3syn
#define _nrn_initial _nrn_initial__stp3syn
#define nrn_cur _nrn_cur__stp3syn
#define _nrn_current _nrn_current__stp3syn
#define nrn_jacob _nrn_jacob__stp3syn
#define nrn_state _nrn_state__stp3syn
#define _net_receive _net_receive__stp3syn 
#define state state__stp3syn 
...
#define tau_f tau_f_stp3syn
 double tau_f = 1000;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "tau_f_stp3syn", 0, 1e+09,
 0,0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 stp3syn /users/mns/lapolina/Desktop/bmtk-release-v1.0.0/docs/examples/biophys_components/mechanisms/modfiles/stp3syn.mod\n");
...
{  double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt;
 ...
 _tsav = t; {
    ...
    double __state = g;
    double __primary = (g + _args[0] * n * p0 * D) - __state;
 ...
 g = g + _args[0] * n * p0 * D ;
   ...
   if (nrn_netrec_state_adjust && !cvode_active_){
    /* discon state adjustment for cnexp case (rate uses no local variable) */
    double __state = n;
    double __primary = (n - n * p0) - __state;
 ...
 tau_r = tau_r - a_FDR * tau_r ;
   ...
   if (nrn_netrec_state_adjust && !cvode_active_){
    /* discon state adjustment for cnexp case (rate uses no local variable) */
    double __state = D;
    double __primary = (D - a_D * p0 * n * D) - __state;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/users/mns/lapolina/Desktop/bmtk-release-v1.0.0/docs/examples/biophys_components/mechanisms/modfiles/stp3syn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
