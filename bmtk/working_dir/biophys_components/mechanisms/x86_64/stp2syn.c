...
#define nrn_init _nrn_init__stp2syn
#define _nrn_initial _nrn_initial__stp2syn
#define nrn_cur _nrn_cur__stp2syn
#define _nrn_current _nrn_current__stp2syn
#define nrn_jacob _nrn_jacob__stp2syn
#define nrn_state _nrn_state__stp2syn
#define _net_receive _net_receive__stp2syn 
#define state state__stp2syn 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 stp2syn /users/mns/lapolina/Desktop/bmtk-release-v1.0.0/docs/examples/biophys_components/mechanisms/modfiles/stp2syn.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/users/mns/lapolina/Desktop/bmtk-release-v1.0.0/docs/examples/biophys_components/mechanisms/modfiles/stp2syn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
