...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 stp5syn /users/mns/lapolina/Desktop/bmtk-release-v1.0.0/docs/examples/biophys_components/mechanisms/modfiles/stp5syn.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/users/mns/lapolina/Desktop/bmtk-release-v1.0.0/docs/examples/biophys_components/mechanisms/modfiles/stp5syn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
