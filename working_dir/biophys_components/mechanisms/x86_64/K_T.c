...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 K_T /users/mns/lapolina/Desktop/bmtk-release-v1.0.0/docs/examples/biophys_components/mechanisms/modfiles/K_T.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/users/mns/lapolina/Desktop/bmtk-release-v1.0.0/docs/examples/biophys_components/mechanisms/modfiles/K_T.mod";
static const char* nmodl_file_text = 
