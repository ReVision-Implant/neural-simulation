...
def fix_axon_peri_multiple_stubs(hobj, num_stubs, stub_lengths, stub_diameters):
    ...
    hobj.axon[0].connect(hobj.soma[0], 0, 0) #0.5 means that the connection is made at the midpoint of the soma
...
conf=bionet.Config.from_json('sim_axon_10_diam_1/conduct_basic_far_z_connect_front/config.json')
conf.build_env()
