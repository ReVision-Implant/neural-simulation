...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 SK /local1/workspace/neural-simulation/v1_Anke/small_population_exp/simulation/components/mechanisms/modfiles/SK.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/local1/workspace/neural-simulation/v1_Anke/small_population_exp/simulation/components/mechanisms/modfiles/SK.mod";
static const char* nmodl_file_text = 
