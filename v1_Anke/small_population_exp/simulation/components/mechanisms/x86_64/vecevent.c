...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 VecStim /local1/workspace/neural-simulation/v1_Anke/small_population_exp/simulation/components/mechanisms/modfiles/vecevent.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/local1/workspace/neural-simulation/v1_Anke/small_population_exp/simulation/components/mechanisms/modfiles/vecevent.mod";
static const char* nmodl_file_text = 
