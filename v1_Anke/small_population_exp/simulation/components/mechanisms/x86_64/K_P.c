...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 K_P /local1/workspace/neural-simulation/v1_Anke/small_population_exp/simulation/components/mechanisms/modfiles/K_P.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/local1/workspace/neural-simulation/v1_Anke/small_population_exp/simulation/components/mechanisms/modfiles/K_P.mod";
static const char* nmodl_file_text = 
