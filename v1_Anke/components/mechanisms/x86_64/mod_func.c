...
void modl_reg(){
  if (!nrn_nobanner_) if (nrnmpi_myid < 1) {
    ...
    fprintf(stderr," \"modfiles/exp1isyn.mod\"");
    fprintf(stderr," \"modfiles/exp1syn.mod\"");
    ...
    fprintf(stderr," \"modfiles/mammalian_spike_Anke.mod\"");
    ...
    fprintf(stderr," \"modfiles/stp1syn.mod\"");
    fprintf(stderr," \"modfiles/stp2syn.mod\"");
    fprintf(stderr," \"modfiles/stp3syn.mod\"");
    fprintf(stderr," \"modfiles/stp4syn.mod\"");
    fprintf(stderr," \"modfiles/stp5isyn.mod\"");
    fprintf(stderr," \"modfiles/stp5syn.mod\"");
