def make_slice_edges(path_h5file,path_h5_edgefile,path_edge_slice,v1=False):
    ...
    #check_nan=np.isnan(v1_node_id_slice).any();
    #if check_nan:
        #print('unexpected NaN values found in v1_node_id')
    #else:
        #print('no NaN data in v1_node_id');
    ...
    for vector in edges_list:
        ...
        has_nan=np.isnan(filtered_vector).any();
        #if has_nan:
            #print('unexpected NaN values found in the data.')
        #else:
            #print('No NaN values found int the data') 
    ...
    shutil.copyfile(path_h5_edgefile,path_edge_slice)

    #open copied file for modification
    with h5py.File(path_edge_slice, 'a') as slice_edge_test:
        if 'edges' in slice_edge_test: # deletes the information from prev file 
            del slice_edge_test['edges']
...
#test functie
#make_slice_edges('/scratch/leuven/356/vsc35693/neural-simulation/v1_Anke/virtual_mice/mouse_0/v1_nodes.h5','/scratch/leuven/356/vsc35693/neural-simulation/v1_Anke/virtual_mice/mouse_0/v1_v1_edges.h5','/scratch/leuven/356/vsc35693/neural-simulation/v1_Anke/slices/test_slice/v1_v1_edges.h5');