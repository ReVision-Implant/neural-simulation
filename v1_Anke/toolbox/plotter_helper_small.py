...
class SubPlotter():
    ...
    def __init__(self, ax, exp, pattern = 'small', network = 'network_mask_dense' , depth=None, sigma=10, centroid=True, electrodes=True, ticks=True):
        ...
        :param patterns: (int/str or list thereof) Pattern names. default to small
        :param networks: (int/str or list thereof) networks. 
    ...
    def set_dirs(self):
        ...
        kwargs = dict(nodes_dirs=nodes_dirs, spikes_dirs=spikes_dirs, pattern_dirs=pattern_dirs, electrodes_dirs=electrodes_dirs, radius=radius, v1=True)
