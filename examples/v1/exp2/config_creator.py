...
def create_configs(electrodes, stim_types, amplitudes, networks, overwrite=False):
    for electrode in electrodes:
        ...
        for stim_type in stim_types:
            ...
            comsol_file = '$STIM_DIR/exp2/0' + str(electrode) + str(stim_type) + '.txt'
            ...
            for amplitude in amplitudes:
                ...
                for network in networks:
                    ...
                    data['manifest']["$OUTPUT_DIR"] = '$BASE_DIR/exp2/output/' + str(electrode) + '/' + str(stim_type) + '/' + str(amplitude) + '/' + name
